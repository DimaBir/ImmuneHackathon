...
$response = Invoke-WebRequest -UseBasicParsing -Uri $KustoUri `
   ...
   -Body "{`"db`":`"Geneva`",`"csl`":`"GetTvmLogs`n| getschema`",`"properties`":{`"Options`":{`"servertimeout`":`"00:04:00`",`"queryconsistency`":`"strongconsistency`",`"query_language`":`"kql`",`"request_readonly`":false,`"request_readonly_hardline`":false}}}"
